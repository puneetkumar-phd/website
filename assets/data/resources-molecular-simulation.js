...
window.RESOURCE_LIBRARY["molecular-simulation"] = (window.RESOURCE_LIBRARY["molecular-simulation"] || []).concat([
  {
    "name": "PLUMED",
  ...
  },
  {
    ...
    "tags": ["software", "molecular dynamics", "tutorial", "GPU", "trajectory analysis", "documentation"]
  }
  {
    "name": "AMBER",
    "description": "AmberTools consists of several independently developed packages that work well by themselves, and with Amber26. The suite can also be used to carry out complete molecular dynamics simulations, with either explicit water or generalized Born solvent models.",
    "website": "https://ambermd.org/tutorials/",
  ...
  }
  {
    ...
    "website": "https://www.ks.uiuc.edu/Training/Tutorials/namd/namd-tutorial-html/",
